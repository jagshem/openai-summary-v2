...
export default function Home() {
  ...
  return (
    <div className="container mx-auto my-6 px-4">
      <header className="border-b pb-6 mb-6 text-center md:text-left">
        <div>
          <h6 className="flex items-center justify-center gap-x-2 text-xl font-bold">
            SUMMARY
      ...
      <form
        ...
        className="flex flex-wrap gap-x-4 gap-y-4 justify-center items-center"
      >
        <input
          type="password"
          value={apiKey}
          ...
          className="w-full md:w-[400px] bg-zinc-100 outline-none focus:bg-zinc-300 p-4 rounded-md text-[15px] font-medium"
        />
        <textarea
          value={query}
          id="input-textarea"
          ...
          className="w-full md:w-[400px] bg-zinc-100 outline-none focus:bg-zinc-300 p-4 rounded-md text-[15px] font-medium resize-none max-h-[225px] overflow-y-auto loading:cursor-pointer-events-none"
        />
        <button
        ...
        {summaries.length > 0 && (
          <div className="mt-6">
            ...
            {summaries.map((item, index) => (
              <div
                className="flex mb-3 flex-col md:flex-row gap-y-4 md:gap-y-0"
                key={item.key}
              >
                <div className="w-full md:w-1/2 p-4 bg-zinc-100 rounded-md">
                ...
                <button
                  ...
                  className="h-10 px-4 md:ml-3 rounded-md bg-red-500 text-white font-bold hover:bg-red-400 self-start"
                >
                  X
                </button>
              </div>
